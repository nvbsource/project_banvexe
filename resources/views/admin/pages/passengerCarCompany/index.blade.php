...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Danh sách các chuyến xe
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-muted">Passenger Car Company</li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-200 w-5px h-2px"></span>
            </li>
        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-customer-table-filter="search"
                    class="form-control form-control-solid w-250px ps-15" placeholder="Tìm kiếm doanh nghiệp" />
            </div>
        </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table-list">
            <thead>
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Tên công ty</th>
                    <th class="min-w-125px">Số điện thoại</th>
                    <th class="min-w-125px">Đánh giá</th>
            ...
            <tbody class="fw-bold text-gray-600">
                ...
                <tr>
                    ...
                    <td>
                        <div class="rating">
                            @for ($i = 1, $countRating = floor($company->evaluates->avg('rating')); $i <= 5; $i++)
                                <div class="rating-label {{$i <= $countRating ? 'checked' : ''}}">
