                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <div class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px"
                            style="">
                            <div class="menu-item">
                                <a class="menu-link" href="/metronic8/demo1/../demo1/documentation/base/utilities.html"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                    data-bs-placement="right" data-kt-initialized="1">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="/metronic8/demo1/../demo1/documentation/getting-started.html"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                    data-bs-placement="right" data-kt-initialized="1">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-3">
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                    href="/metronic8/demo1/../demo1/documentation/getting-started/changelog.html">
                                    <span class="menu-icon">
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img src="{{asset('admin/assets/media/avatars/150-1.jpg')}}" alt="user">
                    </div>
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        data-kt-menu="true"
                        style="z-index: 105; position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-30px, 70px, 0px);"
                        data-popper-placement="bottom-end">
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="http://127.0.0.1:8000/admin/assets/media/avatars/150-1.jpg">
                                </div>
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        {{Auth::guard("bms")->user()->name}}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                                    </div>
                                    <span class="fw-semibold text-muted text-hover-primary fs-7">
                                        {{Auth::guard("bms")->user()->roleUser->name}}
                                    </span>
                                </div>
                            </div>
                        </div>
